...
class AppDelegate: NSObject, NSApplicationDelegate, NSUserNotificationCenterDelegate {
    ...
    @IBOutlet weak var runningStatusMenuItem: NSMenuItem! // 打开vpn
    @IBOutlet weak var toggleRunningMenuItem: NSMenuItem! // 关闭
    @IBOutlet weak var autoModeMenuItem: NSMenuItem!  // PAC 自动模式
    @IBOutlet weak var globalModeMenuItem: NSMenuItem! // 全局模式
    @IBOutlet weak var manualModeMenuItem: NSMenuItem! // 手动模式
    
    @IBOutlet weak var serversMenuItem: NSMenuItem! // 服务器
    @IBOutlet var showQRCodeMenuItem: NSMenuItem! // 扫描屏幕上二维码
